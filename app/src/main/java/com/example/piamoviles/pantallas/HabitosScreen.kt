...
@Composable
fun HabitosScreen(navController: NavController, mascotaId: Int) {
    ...
    PetDetailScreen(
        ...
        content = {
            Text("Habitos de ${mascota?.nombre}:", Modifier.padding(8.dp))
            Text(mascota?.habitos ?: "", Modifier.padding(8.dp))
        }
    )
}