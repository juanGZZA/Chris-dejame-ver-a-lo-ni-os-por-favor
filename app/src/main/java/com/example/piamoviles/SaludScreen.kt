...
fun SaludScreen(navController: NavController){
    Column(
        ...
        Text("Peso: 15kg", fontSize = 16.sp, modifier = Modifier.padding(8.dp))
        Text("Edad: 8 años", fontSize = 16.sp, modifier = Modifier.padding(8.dp))
        Text("Raza: chihuahua", fontSize = 16.sp, modifier = Modifier.padding(8.dp))
        Text("Kilometros recorridos en los ultimos 7 días: 2.1km", fontSize = 16.sp, modifier = Modifier.padding(8.dp))
        Row(
